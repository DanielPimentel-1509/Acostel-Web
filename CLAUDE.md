...
6. **Desarrollar guiado por retorno.** Toda funcionalidad o módulo nuevo debe aportar al menos una de estas tres cosas: **aumentar ventas**, **reducir trabajo manual**, o **mejorar la experiencia del cliente**. Si no aporta ninguna, se pausa — no se construye por completitud, por elegancia técnica, ni por "ya que estamos". Ante dos opciones que aportan, se prioriza la de mayor retorno por hora de trabajo.
...
| 1.4 | 2026-07-19 | Agrega el Principio 6: desarrollar guiado por retorno (aumentar ventas / reducir trabajo manual / mejorar experiencia del cliente — si no aporta ninguna, se pausa), propuesto por el cliente. |
